            ...
            for(int y=0;y<SIZE;y+=1) {
                ...
                //if(col > 0.0) { 
                    ...
                    if(invar.isSelected()) {
                        ...
                        build.append("\n");
                        build2.append("<{p"+exid+"["+String.valueOf(USED_X)+","+String.valueOf(USED_Y)+"]} --> ["+LABEL+"]>,");
                    } else {
                        build.append("<{p"+exid+"["+String.valueOf(USED_X)+","+String.valueOf(USED_Y)+"]} --> ["+LABEL+"]>. %"+String.valueOf(freq)+"%");
                        build.append("\n");
                        build2.append("<{p"+exid+"["+String.valueOf(USED_X)+"_"+String.valueOf(USED_Y)+"]} --> ["+LABEL+"]>,");
                    }
                //}
            }
        }
                ...
                if(s!=null) {
                    ...
                    try {
                        for(int h=0;h<exid;h++) {
                            ...
                            System.out.println(additional[h]);
                        }
